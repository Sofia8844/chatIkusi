...
const Header: FC<HeaderProps> = ({ avatarUrl }) => {
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-white/30 dark:border-surface-dark/20 px-4 sm:px-6 lg:px-10 py-3 bg-transparent">
      <div className="flex items-center gap-8">
        <div className="flex items-center gap-4 text-text-primary-light dark:text-text-primary-dark">
          ...
          <h2 className="text-text-primary-light dark:text-text-primary-dark text-lg font-bold leading-tight tracking-[-0.015em]">IKUSITO</h2>
        </div>
      </div>

      <div className="flex flex-1 justify-end gap-4 sm:gap-6 lg:gap-8">
        <div className="hidden md:flex items-center gap-9">
          <a className="text-sm font-medium cursor-pointer">Plantillas</a>
          <a className="text-sm font-medium cursor-pointer">Recursos</a>
          <a className="text-sm font-medium cursor-pointer">Precios</a>
        </div>
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${avatarUrl || "https://lh3.googleusercontent.com/ogw/..."}`
          }}
        ></div>
      </div>
    </header>
